...
public class ComposicaoAcidosMB implements Serializable {
    ...
    private Class<ComposicaoAcidos> classe = ComposicaoAcidos.class;
    
    private RowStateMap stateMap = new RowStateMap();
    private ComposicaoAcidos obj = new ComposicaoAcidos();
    
    private int totalColunas;
    
    public ComposicaoAcidosMB() {
        ...
        for (int j = 1; j <= 200; j++) {
            ComposicaoAcidos tmp = new ComposicaoAcidos();
    ...
    public List<ComposicaoAcidos> getListaItens() {
        return listaItens;
    }

    public void setListaItens(List<ComposicaoAcidos> listaItens) {
