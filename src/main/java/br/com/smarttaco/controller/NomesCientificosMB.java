...
public class NomesCientificosMB implements Serializable {
    ...
    private Class<NomesCientificos> classe = NomesCientificos.class;
    ...
    public NomesCientificosMB() {
        ...
        for (int j = 1; j <= 200; j++) {
            NomesCientificos tmp = new NomesCientificos();
            tmp.setAlimento("Linha "+j);
    ...
    public List<NomesCientificos> getListaItens() {
        return listaItens;
    }

    public void setListaItens(List<NomesCientificos> listaItens) {
