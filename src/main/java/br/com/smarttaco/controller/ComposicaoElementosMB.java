...
@ManagedBean
@SessionScoped
public class ComposicaoElementosMB implements Serializable {
    
    private List<ComposicaoElementos> listaItens = new ArrayList<ComposicaoElementos>();
    ...
    private Class<ComposicaoElementos> classe = ComposicaoElementos.class;
    
    private RowStateMap stateMap = new RowStateMap();
    private ComposicaoElementos obj = new ComposicaoElementos();
    private CabecalhoMB cabecalho = CabecalhoMB.getInstance();
    
    private int totalColunas;
    
    public ComposicaoElementosMB() {
         ...
         */
        for (ComposicaoElementos tmp : listaItens) {
            for ( Field atributo: classe.getDeclaredFields() ) {
                try {
                    Method method = ComposicaoElementos.class.getMethod( tmp.montarNomeSimplesMetodo( atributo.getName() ) );
    ...
    public List<ComposicaoElementos> getListaItens() {
        return listaItens;
    }

    public void setListaItens(List<ComposicaoElementos> listaItens) {
